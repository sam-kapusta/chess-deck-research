...
| **Missed Defensive Resource** | DELETED (2026-07-15) | 3.8% | Missed-direction TWIN of ignored_threat — same crude is_attacked_by+undefended test. 1% sole-explain, ~44% of those phantom (opp doesn't capture); 45% co-fire Allowed Hanging Piece + hundreds Hung X. In-check branch fired 0×. Concept survives via Hung <Piece> → Allowed Hanging Piece; redundant synonym. (Never in taxonomy → neutral in prod.) |
